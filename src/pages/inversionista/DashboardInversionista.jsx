...
function DashboardInversionista({ usuarioData, onCerrarSesion, onOpenSettings, onBackHome, onOpenChat, onOpenInvestments, onOpenFoundyCard, showSidebar = true, embeddedLayout = false }) {
