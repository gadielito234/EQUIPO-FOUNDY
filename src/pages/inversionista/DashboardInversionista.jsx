    ...
    return (
        <div className="min-h-screen bg-[#efeee7] text-[#1e4043]">
            <div className="flex min-h-screen">
                <aside className={`${sidebarOpen ? 'w-64' : 'w-[4.5rem]'} fixed inset-y-0 left-0 z-30 flex flex-col border-r border-[#d9d3c7] bg-[#f5f2eb] p-4 transition-all duration-200 lg:static`}>
