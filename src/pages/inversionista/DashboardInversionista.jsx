...
import { Bell, CircleHelp, Home, LogOut, Mail, Menu, Settings, Wallet, X } from 'lucide-react';
import { supabase } from '../../services/supabase.js';
import UnifiedNavigation from '../shared/UnifiedNavigation.jsx';
...
function DashboardInversionista({ usuarioData, onCerrarSesion, onOpenSettings, onBackHome, onOpenChat, onOpenInvestments, onOpenFoundyCard }) {
    ...
    return (
        <div className="min-h-screen bg-[#efeee7] pt-16 text-[#1e4043] lg:pl-64">
            <UnifiedNavigation role="investor" active="home" user={name} avatar={usuarioData?.avatar} onBackHome={onBackHome} onOpenSettings={onOpenSettings} onOpenChat={onOpenChat} onOpenInvestments={onOpenInvestments} onOpenFoundyCard={onOpenFoundyCard} onCerrarSesion={onCerrarSesion} onNotice={showNotice} onSearch={setSearchTerm} />
