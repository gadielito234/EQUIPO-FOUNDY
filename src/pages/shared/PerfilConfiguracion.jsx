...
import EntrepreneurLayout from './EntrepreneurLayout.jsx';
...
export default function PerfilConfiguracion({ usuarioData, onCerrarSesion, onBackHome, onOpenCreateProject, onOpenProjects, onOpenStatistics, onOpenChat, onOpenFoundyCard }) {
  ...
  return (
    <EntrepreneurLayout active="settings" user={displayName} onBackHome={onBackHome} onOpenCreateProject={onOpenCreateProject} onOpenProjects={onOpenProjects} onOpenStatistics={onOpenStatistics} onOpenChat={onOpenChat} onOpenSettings={() => {}} onOpenFoundyCard={onOpenFoundyCard} onCerrarSesion={onCerrarSesion}>
