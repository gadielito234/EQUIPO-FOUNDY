...
function Inicio({ usuarioData, onCerrarSesion, onOpenSettings, onOpenCreateProject, onOpenChat, onOpenFoundyCard, onOpenNotifications }) {
    ...
    const handleNavigation = (label) => {
        ...
        if (label === 'Notificaciones') onOpenNotifications?.();
    };
